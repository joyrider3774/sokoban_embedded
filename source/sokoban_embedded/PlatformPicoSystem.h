...
//Only what changed since the last frame is sent, but a frame that changes all over (the view
//scrolling) scaled is 3.5 times the pixels of 128x128, and that is slow. Only a frame from a screen
