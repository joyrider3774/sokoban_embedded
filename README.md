...
| [Gamebuino META](https://gamebuino.com/gamebuino-meta) | GamebuinoMeta_Sokoban.zip | unzip it onto the SD card, it holds a Sokoban_embedded folder with the game, its save and the loader's images, the .hex in it is for flashing the game directly |
